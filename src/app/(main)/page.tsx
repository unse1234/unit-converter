...
import { LanguageCards } from '@/components/i18n/LocalizedPages';
  ...
  return (
    <>
      ...
      <div className="page-shell space-y-12 pb-8">
        ...
        <Section
          title="UnitFlip in your language"
          description="Converters written for each market, with the units and the searches people use there."
        >
          <LanguageCards current="en" />
        </Section>
      </div>
    </>
  );
