          ...
          <Section title="Privacy and cost">
            <Prose>
              <p>
                ...
                Advertising and analytics from Google keep the site running and do set cookies; the{' '}
                <Link href="/privacy-policy">privacy policy</Link> explains exactly what they
