        ...
        <div className="mt-10 space-y-10">
          <Section title="Reporting a wrong conversion">
            <Prose>
              ...
              <p>
                Every constant on this site comes from a defining authority rather than from another
                converter; the <Link href="/about">about page</Link> lists the sources.
              </p>
            </Prose>
          </Section>
          ...
          <Section title="Accessibility problems">
            <Prose>
              <p>
                If something here does not work with a screen reader, a keyboard alone, or at a zoom
                level you need, that is a bug and we want to hear about it. Please say which
